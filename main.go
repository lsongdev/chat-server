...
func run() error {
	...
	protected.HandleFunc("/conversations/{id}", api.DeleteConversation).Methods(http.MethodDelete)
	protected.HandleFunc("/conversations/{id}/leave", api.LeaveConversation).Methods(http.MethodPost)
	protected.HandleFunc("/conversations/{id}/members", api.ListMembers).Methods(http.MethodGet)
	protected.HandleFunc("/conversations/{id}/members", api.AddMember).Methods(http.MethodPost)
	protected.HandleFunc("/conversations/{id}/members/{userID}", api.RemoveMember).Methods(http.MethodDelete)
	protected.HandleFunc("/conversations/{id}/members/{userID}", api.UpdateMemberRole).Methods(http.MethodPatch)
	protected.HandleFunc("/contacts", api.ListContacts).Methods(http.MethodGet)
	protected.HandleFunc("/contacts", api.SaveContact).Methods(http.MethodPost)
